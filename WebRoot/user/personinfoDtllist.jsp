...
<hr />
<table align="center" >
<form action="act_User_queryDtl" method="post" name="form1" > 
    <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;人员名称：</td>
      <td>
  ...
  <form  action="">
    <table border="1" align="center"  bordercolor="#3399FF" id="customers">
	  ...
	  <tr>
        ...
        <td >
        <a href="act_User_showDtl?id=${bean.id}">${bean.truename}</a>
        </td>
        <td >
        ${bean.role.dicname}
        </td>
...
<table width="600" align="center" class="boc3">
    <tr class="boc3" align="center">
      <td width="499" align="center">
		<a href="#" onclick="update_tbl('customers','del','act_User_findDtl')">修改</a>
	   <a href="####" onclick="update3_tbl('customers','del','act_User_showDtl')">查看</a></td>
    </tr>
