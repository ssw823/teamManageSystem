...
<body onload="init();"  style="background-color: #EFFAFE;">
<br/>
<span class="title">
球队人员管理
</span>
<hr />
 <form  method="post" action="act_User_addPersonInfo" class="demoform">
  <p style="color: red;font-size: 16px;">${message}</p>
    <table width="400" border="1"   bordercolor="#3399FF" id="customers">
      ...
      <tr>
	   ...
	   <td>
	   <div>
	   <img src="images/touxiang.jpg" id="touxiang" width="200px" height="200px"/>
      ...
      <tr>
	   ...
	   <td>
	   <div>
		<select name="role" class="inputxt" datatype="*" onchange="selectCheck(this)">
			<option value="">&nbsp;</option>
			<option value="D0104">队员</option>
      ...
      <tr id="tuiyiTR" style="display: none;">
      ...
      <tr>
	   ...
	   <td>
	   <div><input type="text" name="truename" class="inputxt" datatype="*" errormsg="请输入姓名！" /></div>
       </td>
	  </tr>	  	  	  	  	  
      ...
      <tr>
	   ...
	   <td>
	   <div><input type="text" name="age" class="inputxt" datatype="n" />岁</div>
       </td>
	  </tr>
      ...
      <tr>
	   ...
	   <td>
	   <div>
	   <input id="d11" type="text" name="birthday" onClick="WdatePicker({dateFmt:'MM-dd'})"/>
	   </div>
       </td>
	  </tr>
      <tr>
      ...
      <tr>
	   <th width="10%" height="30" align="center" bgcolor="#3399ff"><span class="need" style="width:10px;">*</span>身高:</th>
	   <td>
	   <div><input type="text" name="height" class="inputxt" datatype="n" />cm</div>
       </td>
	  </tr>
	  
      <tr>
	   <th width="10%" height="30" align="center" bgcolor="#3399ff"><span class="need" style="width:10px;">*</span>体重:</th>
	   <td>
	   <div><input type="text" name="weight" class="inputxt" datatype="n"/>kg</div>
       </td>
	  </tr>	  	  	  
      ...
      <tr>
	   ...
	   <td>
	   	<div><textarea rows="4" cols="230" name="hobby"></textarea></div>
      ...
      <tr>
	   ...
	   <td>
	   <div><textarea rows="4" cols="230" name="special"></textarea></div>
       </td>
	  </tr>	
      <tr>
	   <th width="10%" height="30" align="center" bgcolor="#3399ff">QQ:</th>
	   <td>
	   <div><input type="text" name="qq"/></div>
       </td>
	  </tr>
      ...
      <tr>
	   ...
	   <td>
	   <div><input type="text" name="longmobile"/></div>
       </td>
	  </tr>		  	  
      <tr>
	   <th width="10%" height="30" align="center" bgcolor="#3399ff">短号:</th>
	   <td>
	   <div><input type="text" name="shortmobile"/></div>
       </td>
	  </tr>		     
	  </table>
	  
	  <div id="personability">
<br/>
<br/>
<span class="title">
个人能力信息
	...
	<div style=";margin-left: 350px">
		<div style="width: 600px;margin-top: 30px;">
				   <div style="float: left;font-weight: bold;">进攻：</div>
				      ...
				      <input id="attackSliderSingle" type="slider" name="attack" value="0" />
				    </div>
		...
		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">防守：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defendSliderSingle" type="slider" name="defend" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
		...
		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">速度：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="speedSliderSingle" type="slider" name="speed" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
		...
		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">技术：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="skillSliderSingle" type="slider" name="skill" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
		...
		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">体能：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="powerSliderSingle" type="slider" name="power" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
		...
		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">意识：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="consSliderSingle" type="slider" name="cons" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
 	...
 	<div style=";margin-left: 350px">
  		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">短传：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack1SliderSingle" type="slider" name="attack1" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">中传：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack2SliderSingle" type="slider" name="attack2" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">长传：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack3SliderSingle" type="slider" name="attack3" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">短接：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack4SliderSingle" type="slider" name="attack4" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
  		...
  		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">中接：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack5SliderSingle" type="slider" name="attack5" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">长接：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack6SliderSingle" type="slider" name="attack6" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">跑动：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack7SliderSingle" type="slider" name="attack7" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">路线：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack8SliderSingle" type="slider" name="attack8" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
  		...
  		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">加速：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack9SliderSingle" type="slider" name="attack9" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">弹跳：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack10SliderSingle" type="slider" name="attack10" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">意识：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack11SliderSingle" type="slider" name="attack11" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">团队合作：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="attack12SliderSingle" type="slider" name="attack12" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
	...
	<div style=";margin-left: 350px">
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">防短：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend1SliderSingle" type="slider" name="defend1" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">防中：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend2SliderSingle" type="slider" name="defend2" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">防长：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend3SliderSingle" type="slider" name="defend3" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">防跑：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend4SliderSingle" type="slider" name="defend4" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">区域：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend5SliderSingle" type="slider" name="defend5" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">单挑：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend6SliderSingle" type="slider" name="defend6" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">联防：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend7SliderSingle" type="slider" name="defend7" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">意识：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend8SliderSingle" type="slider" name="defend8" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
   		...
   		<div style="width: 600px;margin-top: 30px">
				   <div style="float: left;font-weight: bold;">团队合作：</div>
		  			...
		  			<div class="layout-slider" style="width: 400px;float: left;margin-left: 20px">
				      <input id="defend9SliderSingle" type="slider" name="defend9" value="0" />
				    </div>
				    <script type="text/javascript" charset="utf-8">
